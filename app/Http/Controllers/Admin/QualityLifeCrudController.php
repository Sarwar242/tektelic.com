...
use App\Http\Requests\QualityLifeRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class QualityLifeCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class QualityLifeCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\QualityLife::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/qualitylife');
        CRUD::setEntityNameStrings('qualitylife', 'quality_lives');
    ...
    {
        CRUD::setValidation(QualityLifeRequest::class);
