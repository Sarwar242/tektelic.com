...
use App\Http\Requests\KeyAreaRequest;
use App\Models\KeyAres;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class KeyAreaCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class KeyAreaCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\KeyAres::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/keyarea');
        CRUD::setEntityNameStrings('keyarea', 'key_areas');
    ...
    {
        CRUD::setValidation(KeyAreaRequest::class);
