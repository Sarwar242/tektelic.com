    ...
    @if($articles->count() >= 1)
        <div class="container">
                                ...
                                <article class="news-card">
                                    <div class="news-card-inner">
                                        ...
                                        <div class="news-card-content">
                                            ...
                                            <a class="news-card-title" href="{{url('articles',['slug' => $article->slug])}}">{{$article->title}}</a>
                                           {{-- <p class="news-card-excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>--}}
                                            <a class="news-card-link" href="{{url('articles',['slug' => $article->slug])}}"><span><?= \App\Models\StaticTextLang::t("news",'See more'); ?></span></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
            ...
            <div class="section-footer" data-aos="fade-in" data-aos-duration="1000" data-aos-delay="150">
                <a class="view-all" href="{{url('articles')}}"><span><?= \App\Models\StaticTextLang::t("news",'View all news'); ?></span></a>
            </div>
        </div>
    @endif
@endif
